...
class HeaderComponent {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    decls: 17,
    vars: 8,
    consts: [["ngClass", "hideBar", "class", "bg-teal-600 dark:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:bg-slate-700 text-white h-screen", 4, "ngIf"], ["class", "relative min-h-screen md:flex", 4, "ngIf"], [1, "sm:hidden", "absolute", "top-0", "z-50", "w-screen"], [1, "flex", "flex-row", "justify-between", "p-4", "m-1", "rounded", "bg-teal-600", "dark:bg-gradient-to-r", "from-indigo-500", "via-purple-500", "to-pink-500", "dark:bg-slate-700", "text-blue-100"], ["routerLink", "home/hero", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Home", 1, "font-bold", "px-4", "rounded", "w-3"], [3, "icon"], ["routerLink", "/home/about", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "About", 1, "font-bold", "px-4", "rounded", "w-3"], ["routerLink", "/home/proyects", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Proyects", 1, "font-bold", "px-4", "rounded", "w-3"], ["aria-label", "Dark Mode", 1, "px-2", 3, "click"], [3, "icon", 4, "ngIf"], ["routerLink", "/admin-panel/login", "aria-label", "Dashboard", 1, "px-2", "font-bold", "hover:text-red-50", "focus:bg-sky-700"], ["ngClass", "hideBar", 1, "bg-teal-600", "dark:bg-gradient-to-r", "from-indigo-500", "via-purple-500", "to-pink-500", "dark:bg-slate-700", "text-white", "h-screen"], ["aria-label", "Alternar barra de navegaci\u00F3n", 1, "flex", "justify-center", "py-2.5", "px-4", 3, "click"], [1, "h-px", "bg-white"], [1, ""], ["routerLink", "home/hero", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Home", 1, "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1", "flex", "justify-center"], ["routerLink", "/home/about", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "About", 1, "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1", "flex", "justify-center"], ["routerLink", "/home/proyects", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Proyects", 1, "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1", "flex", "justify-center"], ["aria-label", "Dark Mode", 1, "py-2.5", "px-5", "flex", "justify-center", "absolute", "bottom-0", 3, "click"], [1, "relative", "min-h-screen", "md:flex"], [1, "sidebar", "bg-teal-600", "dark:bg-gradient-to-r", "from-indigo-500", "via-purple-500", "to-pink-500", "dark:bg-slate-700", "text-blue-100", "w-35", "max-w-35", "space-y-6", "py-7", "px-2", "absolute", "inset-y-0", "left-0", "transform", "-translate-x-full", "md:relative", "md:translate-x-0", "transition", "duration-200", "ease-in-out"], ["href", "#", 1, "text-white", "flex", "items-center", "space-x-2", "px-4"], ["aria-label", "Alternar barra de navegaci\u00F3n", 3, "click"], [1, "text-2xl", "font-extrabold"], [1, "w-full", "h-px", "max-w-6xl", "mx-auto", "my-20", 2, "background-color", "white"], ["routerLink", "home/hero", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Home", 1, "font-bold", "block", "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1"], [1, "mr-2", 3, "icon"], ["routerLink", "/home/about", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "About", 1, "font-bold", "block", "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1"], [1, "mr-5", 3, "icon"], ["routerLink", "/home/proyects", "routerLinkActive", "active", "ariaCurrentWhenActive", "page", "aria-label", "Proyects", 1, "font-bold", "block", "py-2.5", "px-4", "rounded", "transition", "duration-200", "hover:underline", "hover:-translate-x-0.5", "hover:skew-y-1"], [1, "w-11/12", "max-w-full", "absolute", "bottom-0", "text-white"], [1, "h-px", "mb-4", 2, "background-color", "white"], [1, "grid", "grid-cols-2", "gap-4", "my-4"]],
